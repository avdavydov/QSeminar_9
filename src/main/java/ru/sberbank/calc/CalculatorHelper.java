...
public class CalculatorHelper {
    ...
    public String convertIntegerToRoman(int arabic) {
        return roman[arabic];
    }

    public int convertRomanToInteger(String romanNumeral) {
        return Arrays.asList(roman).indexOf(romanNumeral);
    }

    public int do_calc(int number1, int number2, char operation) {
        int result = 0;
        switch (operation) {
            case '+':
